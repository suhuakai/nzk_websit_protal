...
public class MybatisPlusGenerater {
     ...
     * 数据源配置
     */
    private static DataSourceConfig dsc = new DataSourceConfig().setUrl("jdbc:mysql://localhost:3306/his?serverTimezone=UTC&characterEncoding=utf8&useUnicode=true&useSSL=false")
